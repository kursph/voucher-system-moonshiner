 ...
 */
final class Version20221107225428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE voucher_registry (id INT NOT NULL, user_name VARCHAR(255) NOT NULL, voucher TEXT NOT NULL, register_date DATE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN voucher_registry.voucher IS \'(DC2Type:object)\'');
